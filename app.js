...
let storeForm = document.getElementById('lab09')
...
let handleFormSubmit = function (event) {
  ...
  let averageCookiesPerCustomer = parseInt(event.target.averageCookiesPerCustomer.value);
  console.log(location, minHourlyCustomers, maxHourlyCustomers, averageCookiesPerCustomer);

 let newStore= new Storelocation(location, minHourlyCustomers, maxHourlyCustomers, averageCookiesPerCustomer);
 console.log (newStore)
 tfootElement.innerHTML=""
 newStore.render()
 renderTableFooter()
 //storeLocations.push(new Storelocation(location, minHourlyCustomers, maxHourlyCustomers, averageCookiesPerCustomer));
  
  //console.log(shops);

  // let footer = document.getElementById('footer');
  // sales.removeChild(footer);
